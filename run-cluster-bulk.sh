...
R_values=(64 64 64 64 64 64)
L_values=(100 100 100 100 100 100)
M_values=(10 10 10 10 10 10)                  # Example: Point Multiplicity values
S_values=(100000000 100000000 100000000 100000000 100000000 100000000)  # Example: Maximum Cluster Size values
H_values=(0.25 0.5 0.5 0.75 1 1.5)            # Example: Clustering Threshold values
F_values=(0 0 0 0 0 0)              # Example: Hybrid Ratio values
T=96
