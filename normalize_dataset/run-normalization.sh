...
input_base_path="/home/t-avarhade/big-ann-benchmarks/data/wikipedia_cohere"
output_base_path="/home/t-avarhade/wiki_normalized"

data_file="${input_base_path}/wikipedia_base.bin"
normalized_data_file="${output_base_path}/wiki35M_normalized.bin"
query_file="${input_base_path}/wikipedia_query.bin"
normalized_query_file="${output_base_path}/wiki_normalized_query.bin"

gt_file="${output_base_path}/wiki35M_gt200.bin"
