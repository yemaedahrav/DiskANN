...
gt_file="${file_base_path}/ann-datasets/SentenceChunk_OAILarge_gt200_fp32"
query_file="${file_base_path}/ann-datasets/SentenceChunk_OAILarge_query_normalized_6809.bin_fp32"
log_file="${file_base_path}/Amey/DiskANN/results/openai-sentencechunk-baseline/r${r}_l${l}.txt"
