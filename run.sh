...
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r16_l50_mcs32_pm1_t1 -R 16 -L 50 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r16_l50.txt
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r32_l50_mcs32_pm1_t1 -R 32 -L 50 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r32_l50.txt
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r48_l50_mcs32_pm1_t1 -R 48 -L 50 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r48_l50.txt  
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r64_l50_mcs32_pm1_t1 -R 64 -L 50 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r64_l50.txt

# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r16_l100_mcs32_pm1_t1 -R 16 -L 100 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r16_l100.txt
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r32_l100_mcs32_pm1_t1 -R 32 -L 100 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r32_l100.txt
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r48_l100_mcs32_pm1_t1 -R 48 -L 100 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r48_l100.txt
# ./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/wiki_memory_index_clustering_r64_l100_mcs32_pm1_t1 -R 64 -L 100 -T 48 >> /home/rakri/avarhade/DiskANN/wiki1M/wiki_clustering_r64_l100.txt

./apps/build_memory_index --data_path $DATA_FILE --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/test_wiki_memory_index_clustering_r16_l50_mcs32_pm1_t0.001 -R 16 -L 50 -T 1 >> /home/rakri/avarhade/DiskANN/wiki1M/test_wiki_clustering_r16_l50.txt
./apps/search_memory_index --data_type float --dist_fn l2 --index_path_prefix /nvmessd1/fbv4/avarhade/clustering/test_wiki_memory_index_clustering_r16_l50_mcs32_pm1_t0.001 --cluster_path /nvmessd1/fbv4/avarhade/clustering/cluster_mapping_r16_l50_mcs32_pm1_t0.001000.bin --gt_file $GT_FILE --query_file $QUERY_FILE --result_path $RESULT_PATH -K 50 -L 50 100 150 200 250 300 500 -T 1 >> /home/rakri/avarhade/DiskANN/wiki1M/test_wiki_clustering_r16_l50.txt