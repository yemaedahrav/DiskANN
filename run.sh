...
index_path="${file_base}/index/2pass_prec1M_normalized_hybrid_r${R}_l${L}_m${M}_s${S}_h${H}_f${F}"
cluster_path="${file_base}/index/2pass_cluster_r${R}_l${L}_m${M}_s${S}_h${H}_f${F}"
