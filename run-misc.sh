...
gt_file="${base_data}/prec1M_normalized_hybrid_r128_l200_m5_s100000_h0.75_f0.3_gt200"  # This is the path where the new dataset of cluster centres will be saved
